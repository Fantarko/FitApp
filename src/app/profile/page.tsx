...
export default async function ProfilePage() {
 ...
 return (
 <main className="relative min-h-full overflow-hidden px-4 py-6 sm:px-6 sm:py-8 md:px-10 md:py-10"> <BlobBackground
 colors={[
 "var(--color-primary)",
 "var(--color-plum)",
 ]}
 ...
 {/* HEADER */}
 <FadeIn> <section className="glass overflow-hidden rounded-[28px] p-5 sm:p-7"> <div className="flex items-center gap-4 sm:gap-5">
 {/* Avatar */}
 ...
 {/* Name */}
 <div className="min-w-0 flex-1"> <p className="text-xs font-medium uppercase tracking-wide text-ink/40">
 โปรไฟล์นักกีฬา
 </p> <h1 className="mt-1 truncate font-display text-2xl font-bold text-primary-deep sm:text-3xl">
 {profileRes.data?.display_name ??
 "นักวิดพื้น"}
 </h1> <p className="mt-1 text-sm text-ink/50">
 Level {level.level}{" "}
 ...
 {/* XP BAR */}
 <div className="mt-6"> <div className="flex items-center justify-between gap-3 text-xs"> <span className="font-semibold text-primary-deep">
 Level {level.level}
 </span> <span className="text-ink/45">
 {xpCurrent.toLocaleString()} /{" "}
 {xpRequired.toLocaleString()} XP
 </span> </div> <div className="mt-2 h-3 overflow-hidden rounded-full bg-black/10"> <div
 ...
 /> </div> <div className="mt-2 flex justify-between text-[11px] text-ink/40"> <span>ความก้าวหน้า</span> <span>
 {xpRemaining.toLocaleString()} XP ถึง Level{" "}
 {level.level + 1}
 </span> </div> </div> </section> </FadeIn>
 ...
 > <div className="flex items-start justify-between"> <span className="text-lg">{icon}</span> </div> <p className="mt-3 font-display text-2xl font-bold text-primary-deep sm:text-3xl">
 {Number(value).toLocaleString()}
 </p> <p className="mt-1 text-[11px] leading-tight text-ink/45 sm:text-xs">
 {label}
 </p> </FadeIn>
 ))}
 </div>
 ...
 > <div className="flex items-center justify-between gap-3"> <div> <p className="text-xs font-medium text-ink/40">
 COMPETITIVE
 </p> <h2 className="mt-1 font-display text-lg font-semibold">
 การแข่งขัน VS
 </h2> </div> <div className="rounded-full bg-plum/10 px-3 py-1.5 text-xs font-bold text-plum-deep">
 Win Rate {winRate}%
 </div> </div> <div className="mt-5 grid grid-cols-3 divide-x divide-black/10"> <div className="text-center"> <p className="font-display text-2xl font-bold text-green-600">
 {wins}
 </p> <p className="mt-1 text-xs text-ink/45">
 ชนะ
 </p> </div> <div className="text-center"> <p className="font-display text-2xl font-bold">
 {losses}
 </p> <p className="mt-1 text-xs text-ink/45">
 แพ้
 </p> </div> <div className="text-center"> <p className="font-display text-2xl font-bold">
 ...
 รายละเอียด XP
 </h2> </div> <span className="font-display text-lg font-bold text-primary-deep">
 ...
 {icon}
 </span> <p className="text-xs text-ink/45">
 {label}
 </p> </div> <p className="mt-2 font-display font-bold text-primary-deep">
 +{Number(value).toLocaleString()}
 </p> </div>
 ))}
 </div> </FadeIn>
 ...
 {badge.icon}
 </span> <span className="whitespace-nowrap text-sm font-medium">
 {badge.name_th}
 </span> </div>
 ))}
 </div>
 ) : (
 <div className="mt-4 rounded-2xl bg-black/[.03] p-4"> <p className="text-sm text-ink/45">
 ยังไม่มี Badge
 </p> <p className="mt-1 text-xs text-ink/35">
 ...
 {/* NAVIGATION */}
 <FadeIn delay={0.2}> <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4"> <Link
 href="/history"
 ...
 > <span className="block text-xl"> </span> <span className="mt-2 block">
 อันดับ
 </span> </Link> </div> </FadeIn> <div className="h-4" /> </div> </main>
 );
}