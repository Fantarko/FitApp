...
export default async function NotificationsPage() {
  ...
  return <main className="relative flex-1 overflow-hidden px-6 py-10">
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <FadeIn className="mt-4"><h1 className="font-display text-3xl font-bold text-primary-deep">Notifications</h1><p className="mt-1 text-sm text-ink/50">คำขอเพื่อน, VS, Badge, Level Up และ Record ใหม่</p></FadeIn>
