 ...
 */
 ...
 Header
 ========================= */}
 <div className="animate-fade-in mb-8 text-center"> <h1 className="font-display text-3xl font-bold text-plum-deep md:text-4xl">
 ท้าแข่งวิดพื้น
 </h1> <p className="animate-slide-up mt-3 max-w-md text-center text-ink/60">
 ...
 ========================= */}
 {!match && (
 <div className="animate-fade-in grid gap-4"> <div> <p className="font-display text-lg font-semibold text-plum-deep">
 พร้อมท้าคนอื่นหรือยัง?
 </p> <p className="mt-1 text-sm text-ink/50">
 ...
 >
 {loading ? (
 <span className="flex items-center justify-center gap-2"> <span className="h-4 w-4 animate-spin rounded-full border-2 border-white/40 border-t-white" />
 กำลังค้นหาคู่แข่ง...
 </span>
 ) : (
 "หาคู่แข่งแบบสุ่ม"
 ...
 {error && (
 <div className="animate-fade-in rounded-xl bg-red-500/10 px-4 py-3"> <p className="text-sm text-red-500">
 {error}
 </p> </div>
 )}
 ...
 <div className="animate-fade-in grid gap-4"> <div> <p className="font-display text-xl font-bold text-plum-deep">
 ...
 {/* Searching animation */}
 <div className="mx-auto w-full max-w-xs"> <div className="h-2 overflow-hidden rounded-full bg-black/10"> <div className="h-full w-1/2 animate-pulse rounded-full bg-plum-deep" /> </div> </div>

 {/* Live searching indicator */}
 <div className="flex items-center justify-center gap-2 text-sm text-plum-deep"> <span className="h-2 w-2 animate-ping rounded-full bg-plum-deep" /> <span>{match.invite_code ? "รอเพื่อนอยู่..." : "กำลังสแกนหาคู่แข่ง..."}</span> </div>

 {match.invite_code && (
 <div className="rounded-xl bg-black/5 px-3 py-3"> <p className="text-xs text-ink/40">ลิงก์ท้าแข่ง</p> <p className="mt-1 break-all font-mono text-xs text-plum-deep">
 ...
 {/* Match ID */}
 <div className="rounded-xl bg-black/5 px-3 py-2"> <p className="text-xs text-ink/40">
 Match ID
 </p> <p className="mt-1 break-all font-mono text-xs text-ink/60">
 {match.id}
 </p> </div>
 ...
 ========================= */}
 {match?.status === "active" && (
 <div className="animate-fade-in flex flex-col items-center gap-4"> <div> <p className="font-display text-2xl font-bold text-plum-deep">
 จับคู่สำเร็จ!
 </p> <p className="mt-1 text-sm text-ink/60">
 พบคู่แข่งแล้ว
 </p> </div>
 ...
 {/* Loading into VS */}
 <div className="mt-2 flex items-center gap-2 text-sm text-plum-deep"> <span className="h-4 w-4 animate-spin rounded-full border-2 border-plum/30 border-t-plum-deep" />
