...
export default async function BossHistoryPage() {
  ...
  return <main className="relative flex-1 overflow-hidden px-6 py-10">
    ...
    <div className="mx-auto max-w-2xl">
      <Link href="/boss" className="text-sm text-ink/45">← บอส</Link>
      <FadeIn className="mt-4"><h1 className="font-display text-3xl font-bold text-sun-deep">ประวัติศึกบอส</h1><p className="mt-1 text-sm text-ink/50">Best score, จำนวนครั้งที่ใช้ และวันที่ปราบได้</p></FadeIn>
